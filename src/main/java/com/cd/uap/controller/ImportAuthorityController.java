...
import com.cd.uap.service.ImportAuthorityService;
import com.cd.uap.utils.CodeMessage;

@RestController
@RequestMapping("/api/uap/v1/authorityIO")
public class ImportAuthorityController extends BaseController {
	private static Logger log = LoggerFactory.getLogger(ImportAuthorityController.class);
	@Autowired
	...
	public Response importFile(@RequestParam(value = "file") MultipartFile file,Integer appId) {
		Response response = null;
		String message = "";
		try {
			message = importAuthorityService.importFile(file,appId);
